...
class ViewWidget extends StatefulWidget {
  final UssdViewObject preloadedData;
  final String initialSessionText;

  const ViewWidget({
    super.key,
    required this.preloadedData,
    required this.initialSessionText,
  });

  static Future<UssdViewObject> loadInitialData(String sessionText) async {
...
class _ViewWidgetState extends State<ViewWidget> {
  ...
  late UssdViewObject ussdData;

  @override
  void initState() {
    super.initState();
    sessionText = widget.initialSessionText;
    inputController.text = '';
    ussdData = widget.preloadedData;

    final timerController = Get.put(TimerDialogController());
    timerController.startTimer();
  }

  // Replace FutureBuilder with direct content
  @override
      ...
      children: [
        Flexible(
          ...
          child: ListView.builder(
            ...
            itemCount: ussdData.options?.length ?? 0,
            itemBuilder: (context, index) {
              final option = ussdData.options![index];
              return ListTile(
                dense: true,
